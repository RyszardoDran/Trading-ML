...
- **Backend Development (C#/.NET)**: Follow guidelines in `.github/instructions/csharp.instructions.md`
- **Machine Learning (Python)**: Follow guidelines in `.github/instructions/python-ml.instructions.md`
- **Frontend Development (React)**: Follow guidelines in `.github/instructions/frontend.instructions.md`
...
- **Backend Repository**: C#/.NET (ASP.NET Core) - REST API for trading data and predictions
- **ML Repository**: Python - Stock chart analysis, time-series forecasting, and ML models
- **Frontend Repository**: React + JavaScript/TypeScript - Trading dashboard and visualization
